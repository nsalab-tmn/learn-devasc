...
* **фиксированный (committed)** - это версия файла, сохраненная в репозитории (каталог .git).
* **модифицированный (modified)** - файл был изменен, но не был добавлен в область подготовки или зафиксирован в репозитории.
* **подготовленный (staged)** - измененный файл готов к фиксации в репозитории.
